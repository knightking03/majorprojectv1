...
public partial class rent_budget_deal : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd = new SqlCommand("select * from slider where id=11", con);
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=121", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=122", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=123", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=124", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=125", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=126", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=127", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=128", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=129", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=130", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=131", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=132", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=133", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=134", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=135", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=136", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=137", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=138", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=139", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=140", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=141", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=142", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=143", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=144", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=145", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=146", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=147", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=148", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=149", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=150", con);
        dr = cmd.ExecuteReader();
        dr.Read();
