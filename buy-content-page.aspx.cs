...
public partial class buy_lkn_flat_1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd = new SqlCommand("select image1 from buy where id='"+Session["id"]+"'", con);
        ...
        con.Open();
        cmd = new SqlCommand("select image2 from buy where id='" + Session["id"] + "'", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select image3 from buy where id='" + Session["id"] + "'", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from buy where id='" + Session["id"] + "'", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        Label1.Text = dr["rooms"].ToString(); Label2.Text = dr["area"].ToString(); Label3.Text = dr["floor"].ToString(); Label4.Text = dr["price"].ToString();
        Label5.Text = dr["contact_agent"].ToString(); Label6.Text = dr["description"].ToString(); Label7.Text = dr["transactions"].ToString(); Label8.Text = dr["address"].ToString();
        ...
        Label13.Text = dr["landmarks"].ToString(); Label14.Text = dr["overlooking"].ToString(); Label15.Text = dr["age_of_construction"].ToString(); Label16.Text = dr["authority_verification"].ToString();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Label7.Visible = false; Label8.Visible = false; Label9.Visible = false; Label10.Visible = false; Label11.Visible = false; Label12.Visible = false; Label13.Visible = false;
        Label14.Visible = false; Label15.Visible = false; Label16.Visible = false; Label20.Visible = false; Label18.Visible = false; Label17.Visible = false; Label19.Visible = false;
        ...
        TextBox7.Visible = true; TextBox8.Visible = true; TextBox9.Visible = true; TextBox10.Visible = true; TextBox11.Visible = true; TextBox12.Visible = true; TextBox13.Visible = true;
        TextBox14.Visible = true; TextBox15.Visible = true; TextBox16.Visible = true; TextBox17.Visible = true; TextBox19.Visible = true;
        ...
        TextBox5.Text = dr["contact_agent"].ToString(); TextBox6.Text = dr["description"].ToString(); TextBox7.Text = dr["transactions"].ToString(); TextBox8.Text = dr["address"].ToString();
        ...
        TextBox13.Text = dr["landmarks"].ToString(); TextBox14.Text = dr["overlooking"].ToString(); TextBox15.Text = dr["age_of_construction"].ToString(); TextBox16.Text = dr["authority_verification"].ToString();
