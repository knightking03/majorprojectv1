<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="rent-bachelor-friendly.aspx.cs" Inherits="rent_bachelor_friendly" %>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <h1>ReaL DeaL</h1>
    <em><p>Rent Bachelor Friendly</p></em>
  </div>
    </div>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Lucknow</div></h5>
...
<div class="col-sm-4">
    ...
    <div class="row">
   <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Noida</div></h5>
...
<div class="col-sm-4">
    ...
    <div class="row">
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Banglore</div></h5>
...
<div class="col-sm-4">
    ...
    <div class="row">
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">New Delhi</div></h5>
...
<div class="col-sm-4">
    ...
    <div class="row">
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Goa</div></h5>
