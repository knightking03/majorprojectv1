...
public partial class rent_villa : System.Web.UI.Page
{
    ...
    {
        con.Open();
        cmd = new SqlCommand("select * from slider where id=9", con);
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=61", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=62", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=63", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=64", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=65", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=66", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=67", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=68", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=69", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=70", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=71", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=72", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=73", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=74", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=75", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=76", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=77", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=78", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=79", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=80", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=81", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=82", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=83", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=84", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=85", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=86", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=87", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=88", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=89", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=90", con);
        dr = cmd.ExecuteReader();
        dr.Read();
