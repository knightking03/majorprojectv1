...
public partial class rent_flats : System.Web.UI.Page
{
    ...
    {
        con.Open();
        cmd = new SqlCommand("select * from slider where id=7", con);
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=1", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=2", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=3", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=4", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=5", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=6", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=7", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=8", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=9", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=10", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=11", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=12", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=13", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=14", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=15", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=16", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=17", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=18", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=19", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=20", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=21", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=22", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=23", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=24", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=25", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=26", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=27", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=28", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=29", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id=30", con);
        dr = cmd.ExecuteReader();
        dr.Read();
