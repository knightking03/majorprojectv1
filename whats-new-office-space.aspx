<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="whats-new-office-space.aspx.cs" Inherits="whats_new_office_space" %>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Office Space</div></h5>
    ...
    <div class="row">
        <div class="col-sm-4">
         <div class="card" style="width: 20rem;">
           <asp:Image ID="Image1" runat="server" class="card-img-top " alt="Card image cap" height="250px" Width="318px"/><h6><span class="badge badge-primary"><asp:Label ID="Label25" runat="server" Text="Label"></asp:Label></span></h6>
             <div class="card-body">
               <h5 class="card-title">
 ...
 <div class="col-sm-4">
         <div class="card" style="width: 20rem;">
           <asp:Image ID="Image2" runat="server" class="card-img-top " alt="Card image cap" height="250px" Width="318px"/><h6><span class="badge badge-primary"><asp:Label ID="Label26" runat="server" Text="Label"></asp:Label></span></h6>
             <div class="card-body">
               <h5 class="card-title">
...
<div class="col-sm-4">
         <div class="card" style="width: 20rem;">
            <asp:Image ID="Image3" runat="server" class="card-img-top " alt="Card image cap" height="250px" Width="318px"/><h6><span class="badge badge-primary"><asp:Label ID="Label27" runat="server" Text="Label"></asp:Label></span></h6>
             <div class="card-body">
               <h5 class="card-title">
        ...
        <div class="col-sm-4">
         <div class="card" style="width: 20rem;">
            <asp:Image ID="Image4" runat="server" class="card-img-top " alt="Card image cap" height="250px" Width="318px"/><h6><span class="badge badge-primary"><asp:Label ID="Label28" runat="server" Text="Label"></asp:Label></span></h6>
             <div class="card-body">
               <h5 class="card-title">
 ...
 <div class="col-sm-4">
         <div class="card" style="width: 20rem;">
           <asp:Image ID="Image5" runat="server" class="card-img-top " alt="Card image cap" height="250px" Width="318px"/><h6><span class="badge badge-primary"><asp:Label ID="Label29" runat="server" Text="Label"></asp:Label></span></h6>
             <div class="card-body">
               <h5 class="card-title">
...
<div class="col-sm-4">
         <div class="card" style="width: 20rem;">
            <asp:Image ID="Image6" runat="server" class="card-img-top " alt="Card image cap" height="250px" Width="318px"/><h6><span class="badge badge-primary"><asp:Label ID="Label30" runat="server" Text="Label"></asp:Label></span></h6>
             <div class="card-body">
               <h5 class="card-title">
    ...
    <div class="row">
        <div class="col-sm-4">
         <div class="card" style="width: 20rem;">
           <asp:Image ID="Image7" runat="server" class="card-img-top " alt="Card image cap" height="250px" Width="318px"/><h6><span class="badge badge-primary"><asp:Label ID="Label31" runat="server" Text="Label"></asp:Label></span></h6>
             <div class="card-body">
               <h5 class="card-title">
 ...
 <div class="col-sm-4">
         <div class="card" style="width: 20rem;">
           <asp:Image ID="Image8" runat="server" class="card-img-top " alt="Card image cap" height="250px" Width="318px"/><h6><span class="badge badge-primary"><asp:Label ID="Label32" runat="server" Text="Label"></asp:Label></span></h6>
             <div class="card-body">
               <h5 class="card-title">
...
<div class="col-sm-4">
         <div class="card" style="width: 20rem;">
           <asp:Image ID="Image9" runat="server" class="card-img-top " alt="Card image cap" height="250px" Width="318px"/><h6><span class="badge badge-primary"><asp:Label ID="Label33" runat="server" Text="Label"></asp:Label></span></h6>
             <div class="card-body">
               <h5 class="card-title">
        ...
        <div class="col-sm-4">
         <div class="card" style="width: 20rem;">
          <asp:Image ID="Image10" runat="server" class="card-img-top " alt="Card image cap" height="250px" Width="318px"/><h6><span class="badge badge-primary"><asp:Label ID="Label34" runat="server" Text="Label"></asp:Label></span></h6>
             <div class="card-body">
               <h5 class="card-title">
 ...
 <div class="col-sm-4">
         <div class="card" style="width: 20rem;">
          <asp:Image ID="Image11" runat="server" class="card-img-top " alt="Card image cap" height="250px" Width="318px"/><h6><span class="badge badge-primary"><asp:Label ID="Label35" runat="server" Text="Label"></asp:Label></span></h6>
             <div class="card-body">
               <h5 class="card-title">
...
<div class="col-sm-4">
         <div class="card" style="width: 20rem;">
           <asp:Image ID="Image12" runat="server" class="card-img-top " alt="Card image cap" height="250px" Width="318px"/><h6><span class="badge badge-primary"><asp:Label ID="Label36" runat="server" Text="Label"></asp:Label></span></h6>
             <div class="card-body">
               <h5 class="card-title">
