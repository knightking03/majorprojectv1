<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="buy-flats.aspx.cs" Inherits="buy_flats" %>
...
<div class="col-sm-4">
    ...
    <div class="row">
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Goa Flats</div></h5>
