...
public partial class home_content_page : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd = new SqlCommand("select image1 from homepage where id='" + Session["id"] + "'", con);
        ...
        con.Open();
        cmd = new SqlCommand("select image2 from homepage where id='" + Session["id"] + "'", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select image3 from homepage where id='" + Session["id"] + "'", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from homepage where id='" + Session["id"] + "'", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        Label9.Text = dr["bed_rooms"].ToString(); Label10.Text = dr["bath_rooms"].ToString(); Label11.Text = dr["store_roooms"].ToString(); Label12.Text = dr["flooring"].ToString();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        TextBox9.Text = dr["bed_rooms"].ToString(); TextBox10.Text = dr["bath_rooms"].ToString(); TextBox11.Text = dr["store_roooms"].ToString(); TextBox12.Text = dr["flooring"].ToString();
        ...
        try
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                if (ext == ".jpg" || ext == ".png")
                {
                    ...
                    string ss = "update homepage set image1='" + name + "' where id='" + Session["id"] + "'";
            ...
            if (FileUpload2.HasFile)
            {
                ...
                if (ext == ".jpg" || ext == ".png")
                {
                    ...
                    string ss = "update homepage set image2='" + name + "' where id='" + Session["id"] + "'";
            ...
            if (FileUpload3.HasFile)
            {
                ...
                if (ext == ".jpg" || ext == ".png")
                {
                    ...
                    string ss = "update homepage set image3='" + name + "' where id='" + Session["id"] + "'";
            ...
            //content
            con.Open();
            cmd = new SqlCommand("update homepage set rooms='" + TextBox1.Text + "',area='" + TextBox2.Text + "',floor='" + TextBox3.Text + "',price='" + TextBox4.Text + "',contact_agent='" + TextBox5.Text + "',description='" + TextBox6.Text + "',address='" + TextBox8.Text + "',bed_rooms='" + TextBox9.Text + "',bath_rooms='" + TextBox10.Text + "',store_roooms='" + TextBox11.Text + "',flooring='" + TextBox12.Text + "',landmarks='" + TextBox13.Text + "',authority_verification='" + TextBox16.Text + "',title='" + TextBox17.Text + "',category='" + TextBox19.Text + "',City='" + TextBox21.Text + "' where id='" + Session["id"] + "'", con);
            cmd.ExecuteNonQuery();
            con.Close();
