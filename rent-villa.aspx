<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="rent-villa.aspx.cs" Inherits="rent_villa" %>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Lucknow Villa</div></h5>
...
<div class="col-sm-4">
    ...
    <div class="row">
   <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">New Delhi Villa</div></h5>
...
<div class="col-sm-4">
    ...
    <div class="row">
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Noida Villa</div></h5>
...
<div class="col-sm-4">
    ...
    <div class="row">
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Banglore Villa</div></h5>
...
<div class="col-sm-4">
    ...
    <div class="row">
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Kolkata Villa</div></h5>
