...
public partial class rent_content_page : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd = new SqlCommand("select image1 from rent where id='" + Session["id"] + "'", con);
        ...
        con.Open();
        cmd = new SqlCommand("select image2 from rent where id='" + Session["id"] + "'", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select image3 from rent where id='" + Session["id"] + "'", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        ...
        con.Open();
        cmd = new SqlCommand("select * from rent where id='" + Session["id"] + "'", con);
        dr = cmd.ExecuteReader();
        dr.Read();
        Label1.Text = dr["rooms"].ToString(); Label2.Text = dr["area"].ToString(); Label3.Text = dr["floor"].ToString(); Label4.Text = dr["rent_price"].ToString();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        dr = cmd.ExecuteReader();
        dr.Read();
        TextBox1.Text = dr["rooms"].ToString(); TextBox2.Text = dr["area"].ToString(); TextBox3.Text = dr["floor"].ToString(); TextBox4.Text = dr["rent_price"].ToString();
        ...
        try
        {
            ...
            if (FileUpload1.HasFile)
            {
                ...
                if (ext == ".jpg" || ext == ".png")
                {
                    ...
                    string ss = "update rent set image1='" + name + "' where id='" + Session["id"] + "'";
            ...
            if (FileUpload2.HasFile)
            {
                ...
                if (ext == ".jpg" || ext == ".png")
                {
                    ...
                    string ss = "update rent set image2='" + name + "' where id='" + Session["id"] + "'";
            ...
            if (FileUpload3.HasFile)
            {
                ...
                if (ext == ".jpg" || ext == ".png")
                {
                    ...
                    string ss = "update rent set image3='" + name + "' where id='" + Session["id"] + "'";
