...
public partial class adminpanel_feedback : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd = new SqlCommand("select * from feedback where id='" + i++ + "'", con);
        ...
        if (dr.Read())
        {
            ...
            Label3.Text = dr["feedback"].ToString();
            con.Close();
        }
        else
        {
       ...
       con.Open();
        ...
        if (dr.Read())
        {
            ...
            Label6.Text = dr["feedback"].ToString();
            con.Close();
        }
        else
        {
       ...
       con.Open();
        ...
        if (dr.Read())
        {
            ...
            Label9.Text = dr["feedback"].ToString();
            con.Close();
        }
        else
        {
       ...
       con.Open();
        ...
        if (dr.Read())
        {
            ...
            Label12.Text = dr["feedback"].ToString();
            con.Close();
        }
        else
        {
       ...
       con.Open();
        ...
        if (dr.Read())
        {
            ...
            Label15.Text = dr["feedback"].ToString();
            con.Close();
        }
        else
        {
