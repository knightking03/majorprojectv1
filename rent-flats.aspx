<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="rent-flats.aspx.cs" Inherits="rent_flats" %>
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
    ...
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Kolkata Flats</div></h5>
...
<div class="col-sm-4">
    ...
    <div class="row">
   <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Lucknow Flats</div></h5>
...
<div class="col-sm-4">
    ...
    <div class="row">
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Banglore Flats</div></h5>
...
<div class="col-sm-4">
    ...
    <div class="row">
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">Noida Flats</div></h5>
...
<div class="col-sm-4">
    ...
    <div class="row">
    <div class="col-sm-12"><div class="alert" style="background-color:#6858ed;color:white">
     <h5><div class="text-center">New Delhi Flats</div></h5>
