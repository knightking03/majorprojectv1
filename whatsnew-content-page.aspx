<%@ Page Title="" Language="C#" MasterPageFile="~/home.master" AutoEventWireup="true" CodeFile="whatsnew-content-page.aspx.cs" Inherits="whatsnew_content_page" %>
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="jumbotron" style="background-color: white; padding-bottom: 10px">
                    ...
                    <div class="row" style="margin-left: 30px">
                        <div class="col-sm-4">
                            <div class="alert alert-dark" role="alert">Price</div>
                        </div>
                        <div class="col-sm-8">
                            <div class="alert alert-dark" role="alert" style="font-weight: 600">
